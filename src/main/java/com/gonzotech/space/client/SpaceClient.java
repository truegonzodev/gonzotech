...
>>>>>>> 0a83e65 (Космос: исправление ориентации звёзд (ортонормальный касательный базис к сфере вместо плоских квадов по Z), балансировка яркости (индивидуальная прозрачность + аддитивный блендинг + корректная интерполяция день/ночь для каждого мира))
    }
