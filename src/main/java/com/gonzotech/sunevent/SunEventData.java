 ...
 *
 * <p>Солнечная панель ({@code machines.block.entity.SolarPanelBlockEntity})
 * читает {@link #solarMultiplier()}: −1% за каждый полный день от первого дня
 * мира, пол 10%. Программа «Икар» зовёт {@link #reset()} — счётчик и
 * эффективность обнуляются, расписание начинает отсчитываться от текущего дня
 * заново.
 *
