 ...
 *   <li>день E, 0→12500: I = 1 (багровый день, до «заката»);</li>
 *   <li>день E, 12500→14500: I 1→0 (выход — симметрично входу, 2000 тиков);</li>
 *   <li>ночь с 14500 — обычная (автор: избегать «красной» ночи);</li>
 *   <li>иначе: 0. Текстура солнца красная, когда I &gt; 0 (22000 дня E-1) —
 *       солнце ВСТАЁТ сразу красным.</li>
 * </ul>
 * Ивент длится ~полдня: от E-1 22000 до E 12500 (автор, 2026-09-18).
...
public final class SunEventClient {
    ...
    public static final int EVENT_END = 12500;
    /** Конец плавного выхода 1→0 (тики дня E): с этого часа ночь обычная. */
    public static final int EVENT_FADE_END = 14500;
